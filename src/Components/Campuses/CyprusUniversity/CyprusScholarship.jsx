  ...
  const scholarships = [
    {
      ...
      description: "Granted to all international undergraduate students registering at CIU",
    ...
    },
    {
      ...
      description: "For students with national-level sports performance or joining CIU sports teams",
          ...
          <div className="p-12 md:p-16">
            ...
            <ul className="space-y-4 text-blue-100">
              <li className="flex items-start">
                ...
                <span>Submit your application for admission</span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-white bg-opacity-20 rounded-full p-1 mr-3 mt-1">
                  <svg className="w-2 h-2 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Include all required academic documents</span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-white bg-opacity-20 rounded-full p-1 mr-3 mt-1">
                  <svg className="w-2 h-2 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Provide supporting evidence for special scholarships</span>
              </li>
              <li className="flex items-start">
                <span className="flex-shrink-0 bg-white bg-opacity-20 rounded-full p-1 mr-3 mt-1">
                  <svg className="w-2 h-2 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Scholarships are automatically considered upon application</span>
              </li>
            </ul>
          ...
          <div className="hidden md:block bg-blue-500 bg-opacity-10 relative">
            ...
            <div className="relative h-full flex items-center justify-center p-12">
              <div className="text-center">
                ...
                <div className="text-xl text-blue-100 font-medium">Tuition Coverage</div>
                <div className="text-blue-200 mt-4">Available for qualified students</div>
              </div>
            </div>
          </div>
        </div>
