...
import FinalUniversityIntro from './FinalUniversityIntro';
import FinalUnivesityProgram from './FinalUnivesityProgram';
  ...
  return (
    <div className='mt-4'>
      ...
      <div className='w-full sm:w-11/12 mx-auto'>
        {activeTab === "introduction" && <FinalUniversityIntro />}
        {activeTab === "programs" && <FinalUnivesityProgram />}
        {activeTab === "scholarships" && <FinalUniversityScholorship />}
        {activeTab === "tuition" && <FinalUnivesityTutionfe />}
        {activeTab === "accommodation" && <FinalUniversityAccomo />}
      </div>
    </div>
  );
}
