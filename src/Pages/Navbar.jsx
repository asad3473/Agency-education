      ...
      <div className="w-[90vw] mx-auto">
        ...
        <div className="flex whitespace-nowrap justify-between items-center py-4">
          <div className="flex items-center gap-3">
            <Link to="/">
              <div className="w-10 h-10 sm:w-10 sm:h-10">
                <img
          ...
          {cross && (
            <div
              className="absolute z-50 top-5 right-5 text-white"
              onClick={minusMobile}
            >
          ...
          {first && (
            <div className="z-40 absolute top-0 right-0 min-h-screen w-full sm:w-[300px] px-4 py-10 bg-color1 lg:hidden">
              <div className="flex flex-col items-center">
                ...
                <Link to="/applynow">
                  <button className="px-3 my-3 py-2 btnbg bg-color1 text-lg cursor-pointer rounded-sm font-semibold">
                    Apply Now
                  </button>
                </Link>
              </div>
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link to="/applynow">
              <button className="px-3 py-2 btnbg bg-color1 text-lg cursor-pointer rounded-sm font-semibold">
                Apply Now
              </button>
            </Link>
          </div>
          ...
          <div className="relative z-20 text-sm hidden lg:block cursor-pointer font-semibold group">
            <div className="flex items-center gap-3">
              <input
                ...
                readOnly
                value="Select Language"
                className="bg-transparent border border-gray-500 text-white text-center py-2 rounded-4xl focus:outline-none"
              />
              <Link to="/login">
                <li className="list-none px-4 py-2 rounded-md bg-[#F5891B] text-white transition duration-300 hover:bg-[#F5891B] cursor-pointer">
                  Login
                </li>
              </Link>
            </div>
