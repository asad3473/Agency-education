...
const faqs = [
  {
    ...
    answer: (
      <>
        You can apply for your desired program in just a few easy steps, taking
        less than 3 minutes. Simply click on{" "}
        <span className="text-[#0A0851] font-semibold">Apply Now</span>, upload
        your passport and school diploma copies, and select your preferred
        program hassle-free.
      </>
    ),
  },
  {
    ...
    answer:
      "Our free consultation is a personalized session where we assess your academic background, discuss your goals, and recommend the best universities and programs for your needs. We'll guide you through the entire process with expert advice at no cost to you.",
  },
  {
    question: "How many days does it take to get admission?",
    answer:
      "Admissions are typically processed within 2–5 working days after submitting all required documents. Some universities may respond even faster during non-peak periods. We'll keep you updated throughout the process.",
  },
  {
    question: "Are your Services Free?",
    answer:
      "Yes, all our services including consultation, application submission, visa guidance, and accommodation assistance are completely free for students. We're compensated directly by our partner universities, so you never pay for our support.",
  },
];
...
const About = () => {
  return (
    <div className="text-gray-800">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Welcome to our agency, dedicated to helping students navigate
              higher education in North Cyprus. With exclusive agents in all
              universities, we provide seamless registration services. Our
              experienced team offers personalized guidance to ensure a smooth
              application process, visa support, and accommodation assistance.
            </p>
          ...
          <div className="bg-gradient-to-br from-[#0A0851] to-[#F5891B] p-1 rounded-xl shadow-xl">
            <div className="bg-white p-8 rounded-lg h-full">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                At our agency, we understand the importance of personalized
                assistance and expert knowledge in the university application
                process.
              </p>
              <div className="space-y-4">
                {[
                  ...
                  "Comprehensive support from application to accommodation",
                ].map((text, idx) => (
      ...
      {/* Stats Section */}
      <section className="py-10 bg-gradient-to-r from-[#0A0851] to-[#1a1685] text-white">
      ...
      <section className="py-10 px-6 md:px-12 lg:px-24 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We stand out from the competition with our exceptional services and
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-[#F5891B] bg-opacity-10 p-6 rounded-lg flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <div>
                <h4 className="font-bold text-[#0A0851]">
                  Still have questions?
                </h4>
                <p className="text-gray-600">We're here to help</p>
              </div>
            </div>
            <button className="bg-[#0A0851] hover:bg-[#F5891B] border-1 border-[#0A0851]  text-white font-medium py-2 px-6 transition-all duration-300 transform hover:scale-105 shadow-md cursor-pointer">
              CONTACT SUPPORT
            </button>
          </div>
        </div>
