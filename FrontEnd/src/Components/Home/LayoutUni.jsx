                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div className="lg:w-1/2 w-full text-white">
                        <h2 className="text-4xl font-bold mb-6">
                            <span className="text-white underline">Middle East</span> Universities
                        </h2>

                        <p className="text-lg mb-8 leading-relaxed">
                            Qatar has emerged as a global education hub with its prestigious Education City hosting
                            branch campuses of the world's top universities. These institutions offer internationally
                            recognized degrees with a Middle Eastern perspective.
                        </p>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Including Cyprus International,Near East,Eastern Mediterranean.."
                                },
                                {
                                    icon: <FaGlobe className="text-3xl text-[#0A0851]" />,
                                    title: "Global Recognition",
                                    desc: "Degrees identical to main campus diplomas"
                                },
                                {
                                    icon: <FaAward className="text-3xl text-[#0A0851]" />,
                                    title: "Research Excellence",
                                    desc: "State-of-the-art facilities and funding"
                                },
                                {
                                    icon: <FaUserTie className="text-3xl text-[#0A0851]" />,
                                    title: "Career Opportunities",
                                    desc: "Strong industry connections in Qatar's growing economy"
                                }
                            ].map((item, index) => (
