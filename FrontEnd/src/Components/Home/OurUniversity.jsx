      ...
      <div className='grid gap-2 grid-cols-1 sm:gap-10 sm:grid-cols-2 md:grid-cols-3 w-full sm:w-10/12 mt-4 sm:mt-8 mx-auto mb-5'>
        {
          displayedUniversities.map((val, ind) => (
            <div
              className='group relative shadow-md hover:shadow-amber-50 transition-transform duration-300 ease-in-out transform hover:scale-105 shadow-[#0A0851] flex flex-col h-full hover:border hover:border-gray-400'
              key={ind}
            >
              <div
