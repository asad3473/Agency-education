...
const EastTutionFee = () => {
  const tuitionData = {
    overview: {
      description: "NEU offers affordable tuition with 50% automatic scholarships for international students and flexible payment plans.",
      highlights: [
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-[#0A0851] mb-4">Tuition Fees at NEU</h1>
      ...
      <div className="mt-16 bg-[#0A0851] rounded-xl p-8 text-white text-center">
        <h2 className="text-2xl font-bold mb-4">Ready to Start Your Journey at NEU?</h2>
