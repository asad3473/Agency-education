    ...
    <div className="max-w-4xl mx-auto px-4 py-8" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-blue-50 rounded-xl p-6 mb-8">
        ...
        <p className="text-gray-700">
          {isArabic
            ? 'توفر مساكننا المصممة خصيصًا بيئة هادئة ومريحة مع جميع المرافق التي تحتاجها للتركيز على دراستك.'
      ...
      <div className="mb-8">
        <h2 className="text-xl font-bold text-[#0A0851] mb-4">
          {isArabic ? 'جميع الغرف تشمل:' : 'All Rooms Include:'}
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <div className="flex items-center">
            ...
            <span>{isArabic ? 'تلفاز إل سي دي' : 'LCD TV'}</span>
          </div>
          <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <span>{isArabic ? 'خط هاتف' : 'Phone Connection'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6 mb-8">
        <div className="bg-white p-5 rounded-lg shadow-sm">
          <h3 className="text-lg font-bold text-[#0A0851] mb-2 flex items-center">
            <GiHomeGarage className="text-blue-500 mr-2" />
            {isArabic ? 'السكن الاستوديو' : 'Studio Dormitories'}
          </h3>
          <p className="text-gray-700 mb-2">
            {isArabic
              ? 'اختر من وحدات فردية أو مزدوجة أو بأربع غرف نوم بتصميم حديث. يتميز سكن سولي بالعمارة فائقة الحداثة.'
          ...
          <p className="text-sm text-blue-600">
            {isArabic ? 'تشمل الباقات السكن + عضوية الكافتيريا لمدة سنة' : 'Packages include accommodation + 1-year cafeteria membership'}
          </p>
        </div>
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm">
          <h3 className="text-lg font-bold text-[#0A0851] mb-2 flex items-center">
            ...
            {isArabic ? 'شقق السكن' : 'Apartment Dormitories'}
          </h3>
          <p className="text-gray-700">
            {isArabic
      ...
      <div className="bg-[#0A0851] text-white p-6 rounded-xl">
        ...
        <p className="mb-4">{isArabic ? 'وفر أكثر كلما طالت مدة إقامتك معنا:' : 'Save more the longer you stay with us:'}</p>
...
export default BAUaccomodation;
