  ...
  const scholarships = [
    {
      ...
      description: "Granted to all international undergraduate students registering at EMU",
    ...
    },
    {
      ...
      description: "For students with national-level sports performance or joining EMU sports teams",
