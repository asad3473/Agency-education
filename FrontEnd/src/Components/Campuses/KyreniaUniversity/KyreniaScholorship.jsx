  ...
  const scholarships = [
    {
      ...
      description: "Granted to all international undergraduate students registering at UOK",
    ...
    },
    {
      ...
      description: "For students with national-level sports performance or joining UOK sports teams",
