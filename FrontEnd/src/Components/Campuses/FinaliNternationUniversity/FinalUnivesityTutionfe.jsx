  ...
  const tuitionData = {
    overview: {
      description: isArabic
        ? "توفر FIU رسوم دراسية معقولة مع منح تلقائية بنسبة 50٪ للطلاب الدوليين وخطط دفع مرنة."
        : "FIU offers affordable tuition with 50% automatic scholarships for international students and flexible payment plans.",
      highlights: isArabic
        ? [
            "منحة تلقائية بنسبة 50٪ لجميع الطلاب الدوليين",
            "خيارات دفع بالتقسيط شهريًا متاحة",
            "باقة شاملة (الرسوم الدراسية + السكن + الوجبات) تبدأ من 4500 يورو/سنة"
          ]
        : [
    ...
    undergraduate: [
      {
        program: isArabic ? "البرامج القياسية" : "Standard Programs",
        fullFee: "€5,843",
        scholarshipFee: "€3,099",
        icon: <FaUniversity />
      },
      {
        program: isArabic ? "الصيدلة" : "Pharmacy",
        fullFee: "€7,844",
        scholarshipFee: "€4,099",
        icon: <FaFlask />
      },
      {
        program: isArabic ? "طب الأسنان" : "Dentistry",
        fullFee: "€10,645",
        scholarshipFee: "€5,500",
        icon: <FaTooth />
      },
      {
        program: isArabic ? "الطب" : "Medicine",
        fullFee: "€12,955",
    ...
    masters: {
      withThesis: {
        fees: isArabic
          ? [
              { item: "الرسوم لكل مقرر", amount: "€350" },
        ...
        note: isArabic
          ? "*245 يورو في السنة الأولى، 195 يورو بعد السنة الأولى. ضريبة القيمة المضافة تطبق. إضافة 335 يورو لبرامج البيئة."
    ...
    phd: {
      fees: isArabic
        ? [
            { item: "الرسوم لكل مقرر", amount: "€650" },
      ...
      note: isArabic
        ? "*245 يورو في السنة الأولى، 195 يورو بعد السنة الأولى. ضريبة القيمة المضافة تطبق. إضافة 480 يورو لبرامج البيئة."
    ...
    <div className="max-w-7xl mx-auto px-4 py-12" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-[#0A0851] mb-4">
          {isArabic ? "رسوم الدراسة في FIU" : "Tuition Fees at FIU"}
        </h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          {isArabic
            ? "تعليم ميسور مع منح تلقائية للطلاب الدوليين"
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-inner text-center">
            ...
            <p className="text-gray-600 mb-2">
              {isArabic ? "من 4500 يورو/سنة" : "From €4500/year"}
            </p>
          ...
          <table className="min-w-full bg-white rounded-lg overflow-hidden shadow-md">
            <thead className="bg-[#0A0851] text-white">
              <tr>
                ...
                <th className="py-3 px-4 text-right">{isArabic ? "الرسوم كاملة" : "Full Fee"}</th>
                <th className="py-3 px-4 text-right">{isArabic ? "مع منحة 50%" : "With 50% Scholarship"}</th>
              </tr>
            </thead>
      ...
      <div className="space-y-16">
        ...
        {/* PhD Programs */}
        <div>
          <h2 className="text-3xl font-bold text-[#0A0851] mb-6">{isArabic ? "برامج الدكتوراه" : "PhD Programs"}</h2>
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
      ...
      <div className="mt-16 bg-[#0A0851] rounded-xl p-8 text-white text-center">
        <h2 className="text-2xl font-bold mb-4">
          {isArabic ? "هل أنت مستعد لبدء رحلتك في FIU؟" : "Ready to Start Your Journey at FIU?"}
        </h2>
        <p className="mb-6 max-w-2xl mx-auto">
          {isArabic
            ? "تواصل مع فريق القبول لدينا للحصول على معلومات مخصصة حول الرسوم وخطط الدفع."
...
export default FinalUnivesityTutionfe;
