    ...
    <div className="max-w-4xl mx-auto px-4 py-8" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-blue-50 rounded-xl p-6 mb-8">
        ...
        <p className="text-gray-700">
          {isArabic
            ? "توفر مساكننا المصممة خصيصًا بيئة هادئة ومريحة مع جميع وسائل الراحة التي تحتاجها للتركيز على دراستك."
      ...
      <div className="space-y-6 mb-8">
        <div className="bg-white p-5 rounded-lg shadow-sm">
          <h3 className="text-lg font-bold text-[#0A0851] mb-2 flex items-center">
            <GiHomeGarage className="text-blue-500 mr-2" />
            {isArabic ? "المساكن الاستوديو" : "Studio Dormitories"}
          </h3>
          <p className="text-gray-700 mb-2">
            {isArabic
              ? "اختر من وحدات مفردة، مزدوجة أو من 4 غرف نوم بتصميم حديث. يضم سكن سولّي هندسة معمارية فائقة الحداثة."
          ...
          <p className="text-sm text-blue-600">
            {isArabic ? "الباقات تشمل السكن + عضوية الكافتيريا لمدة سنة واحدة" : "Packages include accommodation + 1-year cafeteria membership"}
          </p>
        </div>
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm">
          <h3 className="text-lg font-bold text-[#0A0851] mb-2 flex items-center">
            ...
            {isArabic ? "المساكن الشقق" : "Apartment Dormitories"}
          </h3>
          <p className="text-gray-700">
            {isArabic
              ? "شقق من 2-3 غرف نوم مع غرفة معيشة مشتركة ومطبخ مجهز بالكامل - مثالية للطلاب الذين يرغبون في الطهي."
      ...
      <div className="bg-[#0A0851] text-white p-6 rounded-xl">
        ...
        <p className="mb-4">
          {isArabic ? "وفر أكثر كلما طالت مدة إقامتك معنا:" : "Save more the longer you stay with us:"}
        </p>
